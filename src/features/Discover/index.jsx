...
const Discover = () => {
  ...
  const testimonials = [
    ...
    },
    {
      name: "Sarah K.",
      feedback:
        "This gym has changed my life! The trainers are amazing, and the facilities are top-notch.",
      image: "https://via.placeholder.com/150?text=Jake",
    },
  ];
  ...
  return (
    <div className="bg-gray-100 text-gray-800">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('../../images/animatedShapes.svg')",
        }}
      >
      ...
      <section className="py-16 bg-gray-50">
        <div className="w-full flex flex-col items-center justify-center">
          ...
          <Link className="w-full text-xs text-center mb-8 hover:underline hover:text-red-600" to='/classes-schedule'>see all</Link>
        </div>
